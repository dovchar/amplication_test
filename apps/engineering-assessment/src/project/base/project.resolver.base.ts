...
export class ProjectResolverBase {
  ...
  async createProject(
    ...
    return await this.service.create({
      ...
      data: {
        ...
        indicators: args.data.indicators
          ? {
              connect: args.data.indicators,
            }
          : undefined,
      },
    });
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => Indicator, {
    nullable: true,
    name: "indicators",
  })
  @nestAccessControl.UseRoles({
  ...
  async resolveFieldIndicators(
    @graphql.Parent() parent: Project
  ): Promise<Indicator | null> {
    const result = await this.service.getIndicators(parent.id);
